...
namespace hyperbrowse::ui
{
    ...
    inline constexpr std::array kMainMenuMnemonicCatalog{
        ...
        MenuMnemonicDefinition{L'T', L"Tools"},
    ...
    inline constexpr std::array kViewerShortcutCatalog{
        ...
        ShortcutDefinition{ShortcutContext::Viewer, 0, static_cast<WORD>('G'), FCONTROL, L"Ctrl+G", L"Go to an image by number", L"Viewer navigation"},
