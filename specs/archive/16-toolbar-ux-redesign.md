...
## Implementation Status (refreshed 2026-09-13)
...
| §7 Menu restructuring (consolidated File/Edit/View/Tools/Help, grouped workflows) | **Shipped in the current command-bar/menu structure** — File, Edit, View, Tools, and Help are grouped with metadata, organize, convert, performance, diagnostics, and integration submenus. |
...
> **Scope note:** The owner-drawn, icon-driven toolbar layout and the menu
> grouping are shipped. The toolbar still intentionally uses a buffered GDI
> paint path, and the NanoSVG/D2D alternatives below remain design options,
